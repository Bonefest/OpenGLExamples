...
int main() {
    ...
    // DATA PREPARING  -------------------------------------------------------
    float positions[] = {
        -0.5f, -0.5f,  0.0f, /* color */ 1.0f, 0.0f, 0.0f, /* a = 1.0 */ /* texture */ -1.0f, -1.0f,
         0.5f, -0.5f,  0.0f, /* color */ 0.0f, 1.0f, 0.0f, /* a = 1.0 */ /* texture */ 4.0f, 0.0f,
         0.5f,  0.5f,  0.0f, /* color */ 0.0f, 0.0f, 1.0f, /* a = 1.0 */ /* texture */ 4.0f, 4.0f,
