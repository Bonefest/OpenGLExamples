...
int main() {
    ...
    while(!glfwWindowShouldClose(window)) {
        ...
        glUniform4f(glGetUniformLocation(program.getProgramID(), "uclr"), 1.0f, 0.0f, 0.0f, 1.0f);
        ...
        glBindVertexArray(vao);
        glUniform4f(glGetUniformLocation(program.getProgramID(), "uclr"), 0.0f, 1.0f, 0.0f, 1.0f);
