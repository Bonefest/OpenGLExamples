...
int main() {
    ...
    // SHADER PREPARING ------------------------------------------------------
    Program program("Lights/Shaders/light2_vertex.glsl", "Lights/Shaders/light2_fragment.glsl");
    if(program.hasError()) {
    ...
    while(!glfwWindowShouldClose(window)) {
        ...
        glm::vec3 viewLightSourceLocation = glm::vec3(view * glm::vec4(lightSourceLocation, 1.0f));
        ...
        glUniform3fv(glGetUniformLocation(program.getProgramID(), "sourcePosition"), 1, glm::value_ptr(viewLightSourceLocation));
