...
int main() {
    ...
    // SHADER PREPARING ------------------------------------------------------
    Program program("Lights/Shaders/material_vertex.glsl", "Lights/Shaders/material_fragment.glsl");
    if(program.hasError()) {
    ...
    glm::vec3 objectAmbientColor = glm::vec3(0.0f, 0.1f, 0.06f);
    glm::vec3 objectDiffuseColor = glm::vec3(0.0f, 0.50980392f, 0.50980392f);
    glm::vec3 objectSpecularColor = glm::vec3(0.50196078f, 0.50196078f, 0.50196078f);
    float objectShininess = 32.0f;

    glm::vec3 lightSourceLocation = glm::vec3(0.0f, 1.0f, -1.0f);
    glm::vec3 lightSourceAmbientColor = glm::vec3(1.f, 1.0f, 1.0f);
    ...
    while(!glfwWindowShouldClose(window)) {
        ...
        glUniform3fv(glGetUniformLocation(program.getProgramID(), "material.ambient"), 1, glm::value_ptr(objectAmbientColor));
        glUniform3fv(glGetUniformLocation(program.getProgramID(), "material.diffuse"), 1, glm::value_ptr(objectDiffuseColor));
