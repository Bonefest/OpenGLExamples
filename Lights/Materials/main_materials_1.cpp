...
int main() {
    ...
    glm::vec3 objectAmbientColor = glm::vec3(1.0f, 0.5f, 0.33f);
    glm::vec3 objectDiffuseColor = glm::vec3(1.0f, 0.5f, 0.33f);
    glm::vec3 objectSpecularColor = glm::vec3(0.5f, 1.0f, 0.33f);
    ...
    glm::vec3 lightSourceSpecularColor = glm::vec3(0.0f, 1.0f, 0.0f);
